...
public class Heft {
	...
	*/
	...
	public Heft(List<Cloudlet> cloudletlist, List<Vm> vmlist) {
    ...
    private void calc_TransferCosts() {
        ...
        for (Cloudlet parentObject : Cloudletlist) {
            ...
            for (Cloudlet child : HEFTalgo1.getChildList(parent)) {
    ...
    private double calculateRank(Cloudlet cloudlet) {
        ...
        double max = 0.0;
        for (Cloudlet child : HEFTalgo1.getChildList(cloudlet)) {
    ...
    private void allocateCloudlet(Cloudlet cloudlet) {
        ...
        for (Object vmObject : vmlist) {
            ...
            for (Cloudlet parent : HEFTalgo1.getChildList(cloudlet) ) {
