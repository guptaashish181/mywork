...
public class AntColonySystem {
    ...
    public AntColonySystem(int solLen,int noNodes, int noAnts,Problem prob,FitnessFunction fit){
    ...
    public AntColonySystem(int solLen,int noNodes, int noAnts, double alfa,
    ...
    public int[] getBestTour(){
        ...
        for(int j = 0; j <=solLen; j++)            // storing in array
    ...
    public void computeHeuristic(){
        ...
        System.out.println("--> computeHeuristic ");
        double niu;                                 // heuristic
        int i,j;
        ...
        for(i = 0; i < noNodes; i++)
            ...
            OutputUtil.print("computeHeuristic", choiceInfo);
    ...
    public void localPheromoneUpdate(int ant, int step){
        ...
        System.out.println("LPU: Ant: " + ant + " - " + step);
        
         OutputUtil.print("pheromone", pheromone);
          OutputUtil.print("choiceInfo", choiceInfo);
    ...
    public double[][] getPheromoneMatrix(){
     ...
     public static Map<Integer,Integer> getSCH(Problem prob,FitnessFunction fit) {
       ...
       // System.out.println("Tasks: " + prob.getTasks());
        ...
        AntColonySystem ac= new AntColonySystem(solLen,noNodes, noAnts , prob, fit);
        
        ac.constructSolutions();
