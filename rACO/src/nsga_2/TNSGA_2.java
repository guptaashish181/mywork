...
public class TNSGA_2 {
	...
	/**
	 * Advance one generation algorithm
	 *
	 */
	...
	private void calcCrowdingDistance(ArrayList<TMOIndividual> population) {
		...
		// Since it is an objective function, it is fixed at 2
		for (int i = 0; i < 2; i++) {
			if (i == 0) {
	...
	/**
	 * Parent individuals are selected from population by tournament method
	 *
	 * @return
	 */
	...
	/**
	 * Method for randomly swapping elements of Population<br>
	 * 	This simplifies the process of nonrestoration extraction
	 *
	 */
	public void shuffle() {
